"""Production Experian consumer credit report parser."""
...
from verdin_report_parsers.parsers.experian.extract import (
    build_summary,
    extract_accounts,
    extract_collections,
    extract_consumer,
...
class ExperianParser:
    """Parse Experian 2026 consumer credit report layouts into ``ParsedCreditReport``."""
