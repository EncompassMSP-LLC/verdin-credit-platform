"""Production IdentityIQ monitoring / tri-merge credit report parser."""
...
from verdin_report_parsers.parsers.identityiq.layout import score_layout, split_sections

PARSER_VERSION = "1.0.0"


class IdentityIQParser:
    """Parse IdentityIQ member credit-report PDFs into ``ParsedCreditReport``.
