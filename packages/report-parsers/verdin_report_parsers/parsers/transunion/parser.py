"""Production TransUnion consumer credit report parser."""
...
from verdin_report_parsers.parsers.transunion.extract import (
    build_summary,
    extract_accounts,
    extract_collections,
    extract_consumer,
...
class TransUnionParser:
    ...
    def parse(self, document: ParsedDocument) -> ParsedCreditReport:
        ...
        collections, collection_confidence = extract_collections(sections.get("collections", ""))
