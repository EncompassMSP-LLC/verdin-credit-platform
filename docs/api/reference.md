...
| POST   | `/cases/{case_id}/dispute-strategy/prepare`                       | case_manager | Prepare CRA/furnisher letters from strategy stage (optional `account_keys` for single-account prep; direct accounts prefer parsed-tradeline metadata) |
