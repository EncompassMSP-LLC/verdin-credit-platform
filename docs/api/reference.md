...
| GET    | `/cases/{case_id}/identity-theft/605b-packet.zip`                 | read_only    | Staff-mediated FCRA §605B block packet (bureau letters + readiness; requires confirmed theft)                    |
