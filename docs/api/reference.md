...
| GET    | `/cases/{case_id}/dispute-strategy/attorney-checklist/packet.zip` | read_only    | Download attorney checklist markdown + best-effort exhibits ZIP (optional letters) |
