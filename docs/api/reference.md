...
| GET    | `/cases/{case_id}/issue-explainability`                            | read_only    | Plain-language issue cards with impact categories and evidence recommendations (LRP-208; no score-point promises)                                               |
