...
- Converge background work on a unified `packages/job-orchestrator/` layer for retries, scheduling, metrics, registry, and future queue-service migration.
- Record any significant deviations in ADRs before implementation.

Proposed 4.5 job orchestration package:
