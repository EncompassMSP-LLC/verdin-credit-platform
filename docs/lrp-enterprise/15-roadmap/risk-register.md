...
| RK-002 | Demo auth left enabled in production                  | L   | H   | Mitigating | LRP-108: production builds always disable demo auth                                                                                 | Eng / Ops       |
...
| RK-008 | Partner CRM data loss / no backup                     | L   | H   | Mitigating | [`lrp-v1.0-disaster-recovery-runbook.md`](../../deployment/lrp-v1.0-disaster-recovery-runbook.md); monthly restore drill still open | Ops             |
