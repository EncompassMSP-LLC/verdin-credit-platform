...
## Version 4.3 — Operational Core (shipped)
...
> **Release strategy:** Version 4.3.0 is the **Operational Core** GA release. Tag `v4.3.0` after merge. Version 4.5 focuses on automation (import wizard, AI assistant, dispute generation, workflow) without revisiting platform architecture.
