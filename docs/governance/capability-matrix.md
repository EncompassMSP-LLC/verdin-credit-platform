...
| Capability                      | Version | Status  | Backend | Frontend | API | AI      | Tests | Dependencies        | Notes                                           |
| ------------------------------- | ------- | ------- | ------- | -------- | --- | ------- | ----- | ------------------- | ----------------------------------------------- |
| Workflow Automation             | 4.5     | Partial | 🚧      | 🚧       | 🚧  | —       | ✅    | Timeline, Tasks     | Auto tasks + task list source_module filter     |
...
| Dispute Generation (foundation) | 4.5     | Partial | 🚧      | 🚧       | 🚧  | ✅      | ✅    | Accounts, Documents | Letter lifecycle through CRA response outcomes  |
