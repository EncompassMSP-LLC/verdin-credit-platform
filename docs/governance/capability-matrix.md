...
| Credit Report Import Wizard     | 4.5     | ✅      | ✅      | ✅       | ✅  | —       | ✅    | Documents, OCR      | Wizard, findings, chronology, evidence, strength, strategy, identity theft, §605B packet; parsers: Experian/EQ/TU/ACR + IdentityIQ + SmartCredit |
...
## Version 19.0 — Reinvestigation Benchmark Depth (shipped — ✅)

Scope: [version-19.0-scope.md](version-19.0-scope.md) · Checklist: [version-19.0-completion-checklist.md](../development/version-19.0-completion-checklist.md) · Release: [v19.0.0.md](../release-notes/v19.0.0.md)
...
## Version 20.0 — Reinvestigation Benchmark Parity (shipped — ✅)

Scope: [version-20.0-scope.md](version-20.0-scope.md) · Checklist: [version-20.0-completion-checklist.md](../development/version-20.0-completion-checklist.md) · Release: [v20.0.0.md](../release-notes/v20.0.0.md)
...
## Version 21.0 — Reinvestigation Operations Filters (shipped — ✅)

Scope: [version-21.0-scope.md](version-21.0-scope.md) · Checklist: [version-21.0-completion-checklist.md](../development/version-21.0-completion-checklist.md) · Release: [v21.0.0.md](../release-notes/v21.0.0.md)
...
## Version 23.0 — Document Pipeline Recovery Depth (shipped — ✅)

Scope: [version-23.0-scope.md](version-23.0-scope.md) · Checklist: [version-23.0-completion-checklist.md](../development/version-23.0-completion-checklist.md) · Release: [v23.0.0.md](../release-notes/v23.0.0.md)
...
## Version 24.0 — Document Pipeline Recovery Parity (sign-off)

Scope: [version-24.0-scope.md](version-24.0-scope.md) · Checklist: [version-24.0-completion-checklist.md](../development/version-24.0-completion-checklist.md) · Release: [v24.0.0.md](../release-notes/v24.0.0.md)
...
| LRP demo auth production kill-switch (LRP-108) | 29.0 / V1.0 | ✅      | —       | ✅       | —   | —   | ✅      | Auth             | CRM/lender demo fallback always off in `NODE_ENV=production`; stale demo sessions cleared; local DX opt-in via env                                                         |
| LRP production org mode (LRP-109)              | 29.0 / V1.0 | ✅      | ✅      | ✅       | ✅  | —   | ✅      | Auth/orgs        | `organization_type` + org feature flags; `/org-context`; demo APIs 403 for PRODUCTION; CRM Admin hides demo actions; dedicated `seed_demo_*` scripts                       |
| LRP CRM tasks + daily digest (LRP-102)         | 29.0 / V1.0 | ✅      | ✅      | ✅       | ✅  | —   | ✅      | Tasks            | `GET /tasks/digest/daily`; `/crm/tasks` live list + digest strip; partner health taxonomy deferred                                                                         |
| LRP referral web intake (LRP-103)              | 29.0 / V1.0 | ✅      | ✅      | ✅       | ✅  | —   | ✅      | Mortgage partner | Public `/referral-intake`; client+case+referral+task; SSN quarantine; partner-kit form live                                                                                |
| LRP referral intake orchestrator (LRP-201)     | 29.0 / V1.0 | ✅      | ✅      | —        | ✅  | —   | ✅      | Mortgage partner | Post-accept round-robin assign + staff notify + thank-you drafts; audit runs; quarantine skips; no auto-filing                                                             |
| LRP CRM partner contacts (LRP-101)             | 29.0 / V1.0 | ✅      | ✅      | ✅       | ✅  | —   | ✅      | Mortgage partner | `partner_contacts` + list/create/patch; partnership enrichment; `/crm/partners` live                                                                                       |
| LRP borrower portal core (Vol 19 E2)           | 29.0 / V1.2 | Partial | ✅      | Partial  | ✅  | —   | Partial | Client portal    | Dashboard Vol 19 polish (LRP-303A): partner name, unread updates, overdue, skeletons; band-only readiness (P0-1)                                                           |
| LRP portal password reset (LRP-301A)           | V1.2        | ✅      | ✅      | ✅       | ✅  | —   | ✅      | Client portal    | Self-serve forgot/reset on portal JWT realm; hashed one-time tokens; no email enumeration; token echoed only in development/test                                           |
| LRP portal invite email (LRP-301B)             | V1.2        | ✅      | ✅      | ✅       | ✅  | —   | ✅      | Client portal    | Staff provision/resend invite via matrix PORTAL_INVITE; hashed invite tokens; accept-invite sets password; never emails plaintext passwords                                |
| LRP portal notifications feed (LRP-302A)       | V1.2        | ✅      | ✅      | ✅       | ✅  | —   | ✅      | Client portal    | Dedicated `/portal/notifications` feed + read state; unread badge; matrix BORROWER IN_APP → `portal_notifications`; tenant/borrower isolation; safe `/portal/*` deep links |
| LRP portal message attachments (LRP-302B)      | V1.2        | ✅      | ✅      | ✅       | ✅  | —   | ✅      | Messaging        | Draft upload+policy scan; associate clean files on send; authenticated download; tenant/client isolation; no public storage URLs                                           |
| LRP portal readiness report (LRP-106)          | 29.0 / V1.0 | ✅      | ✅      | ✅       | ✅  | —   | ✅      | Client portal    | `/portal/reports` + readiness-report JSON/export; band-first downloads; disclaimer on every output                                                                         |
| LRP LO notifications center (LRP-105)          | 29.0 / V1.0 | ✅      | ✅      | ✅       | —   | —   | ✅      | Notifications    | `/lender/notifications` + shell/dashboard unread via platform notifications API; demo seed fallback                                                                        |
| LRP notification matrix v1 (LRP-202)           | 29.0 / V1.0 | ✅      | ✅      | —        | ✅  | —   | ✅      | Notifications    | Event→audience→channel registry + idempotent dispatches; referral submit/assign wired; SMS TCPA-gated; realtor optional                                                    |
| LRP CRM automation rules (LRP-203)             | 29.0 / V1.0 | ✅      | ✅      | ✅       | ✅  | —   | ✅      | Mortgage partner | Persisted `crm_automation_rules` + CRM `/crm/automations` live toggle; config only — no unsupervised filing                                                                |
| LRP automation audit events (LRP-502)          | 29.0 / V1.0 | ✅      | ✅      | ✅       | ✅  | —   | ✅      | Mortgage partner | Durable `crm_automation_audit_events`; staff dry-run/fire; live allowlist task/notification; CRM audit list                                                                |
| LRP smoke E2E in CI (LRP-503)                  | 29.0 / V1.0 | —       | —       | —        | ✅  | —   | ✅      | QA / E2E         | `tests/e2e/test_lrp_smoke.py` in E2E workflow; mortgage-partner status→referral→readiness→automation dry-run; `ENABLE_MORTGAGE_PARTNER` in CI                              |
| LRP perf budgets (LRP-504)                     | 29.0 / V1.0 | —       | —       | —        | ✅  | —   | ✅      | QA / perf        | Product p95 budgets (dashboard + readiness export); observe harness in E2E; CI artifact; hard gates deferred                                                               |
| LRP V1.0 release + tag (LRP-505)               | 29.0 / V1.0 | —       | —       | —        | ✅  | —   | ✅      | Release          | `docs/release-notes/lrp-platform-v1.0.0.md` + tag `lrp-platform-v1.0.0`; checklist closeout                                                                                |
| LRP V1.0 post-release hardening                | 29.0 / V1.0 | —       | —       | —        | ✅  | —   | Partial | Ops / Security   | Security sign-off package + DR runbook drafted; officer signature + restore drill open                                                                                     |
| LRP appointment reminders (LRP-205)            | 29.0 / V1.0 | ✅      | ✅      | ✅       | ✅  | —   | ✅      | Mortgage partner | Appointments + idempotent T-24h/T-1h matrix reminders; SMS TCPA-gated; `/crm/calendar` live                                                                                |
| LRP partner nurture drip (LRP-206)             | 29.0 / V1.0 | ✅      | ✅      | ✅       | ✅  | —   | ✅      | Mortgage partner | Programs/steps/enrollments + idempotent delivery; marketing opt-in + TCPA; `/crm/nurture` live                                                                             |
| LRP weekly partner digest (LRP-207)            | 29.0 / V1.0 | ✅      | ✅      | ✅       | ✅  | —   | ✅      | Mortgage partner | Opt-in weekly digests; PII-minimized pipeline snapshot; idempotent week runs; `/crm/digests`                                                                               |
| LRP realtor partner role + login (LRP-301)     | 29.0 / V1.0 | ✅      | ✅      | ✅       | ✅  | —   | ✅      | Mortgage partner | `PartnerRole.realtor`; invites/activation/password reset; `/realtor/*` realm; org/partnership isolation; portal MVP deferred to LRP-302                                    |
| LRP realtor portal MVP (LRP-302)               | 29.0 / V1.0 | ✅      | ✅      | ✅       | ✅  | —   | ✅      | Mortgage partner | Realtor dashboard/referrals/pipeline; PII-minimized initials + coarse stage; no tradelines/dispute letters                                                                 |
| LRP borrower UAT script + fixes (LRP-303)      | 29.0 / V1.0 | ✅      | —       | ✅       | ✅  | —   | ✅      | Client portal    | Manual UAT script + API happy-path/isolation coverage; nav fake-badge removal; demo-off path                                                                               |
| LRP LO UAT script + fixes (LRP-304)            | 29.0 / V1.0 | ✅      | —       | ✅       | ✅  | —   | ✅      | Mortgage partner | Manual LO UAT script + referral→milestone→report happy path; hide seed messages / clarify admin in platform mode                                                           |
| LRP dispute strategy suggestions (LRP-403)     | 29.0 / V1.0 | ✅      | ✅      | ✅       | ✅  | —   | ✅      | Client portal    | Portal advisory suggestions from staff strategy runs; `auto_send=false`; no prepare/send controls                                                                          |
| LRP issue explainability cards (LRP-208)       | 29.0 / V1.0 | ✅      | ✅      | ✅       | ✅  | —   | ✅      | Cases / CRM      | Plain-language issue cards + impact categories; no score-point promises                                                                                                    |
| LRP issue evidence vault links (LRP-208A)      | V1.1        | ✅      | ✅      | ✅       | ✅  | —   | ✅      | Cases / CRM      | Staff-mediated document↔`source_id` associations; soft-delete; no auto-file                                                                                                |
| LRP case action timeline (LRP-208B)            | V1.1        | ✅      | ✅      | ✅       | ✅  | —   | ✅      | Cases / CRM      | Case/CRM panels on append-only `timeline_events`; `source_id` filter; evidence link/unlink emits                                                                           |
| LRP unwanted-call complaints (LRP-209A)        | V1.1        | ✅      | ✅      | ✅       | ✅  | —   | ✅      | Clients / CRM    | Incident CRUD + advisory eligibility + staff drafts; never auto-submit FTC/CFPB/DNC                                                                                        |
| LRP communication preferences (LRP-209)        | 29.0 / V1.0 | ✅      | ✅      | ✅       | ✅  | —   | ✅      | Clients / CRM    | Creditor/collector prefs + guided DNC assistance; never silent registry submit; letter drafts staff-gated                                                                  |
| LRP FAQ/KB retrieval bot (LRP-405)             | 29.0 / V1.0 | ✅      | ✅      | ✅       | ✅  | —   | ✅      | LLM / CRM        | Approved-KB retrieval only; citations; audience filter; org audit + staff feedback; no legal advice / score promises / auto-filing                                         |
| LRP intelligent letter drafts (LRP-406)        | 29.0 / V1.0 | ✅      | ✅      | ✅       | ✅  | —   | ✅      | Cases / CRM      | Template catalog + sectioned drafts + validation; issue-card Generate Letter; staff workflow; `auto_transmit=false`; no score guarantees                                   |
| LRP marketing landings (LRP-305)               | 29.0 / V1.0 | —       | —       | —        | ✅  | —   | ✅      | lrp-web          | `/builders`, `/attorneys`, `/advisors` (+ financial-planners alias); partners hub tiles; claim-safe CTAs only                                                              |
| LRP partner isolation audit (LRP-501)          | 29.0 / V1.0 | ✅      | ✅      | —        | —   | —   | ✅      | Mortgage partner | Cross-tenant denial suite (appointments/rules/intake/audits/realtor scope); capability flag; no partner JWT / marketplace                                                  |
| LRP readiness timeline UI (LRP-401)            | 29.0 / V1.0 | ✅      | ✅      | ✅       | ✅  | —   | ✅      | Client portal    | `/portal/timeline` + `GET /portal/cases/{id}/timeline`; case/readiness/document/task milestones; no staff notes or tradeline dumps                                         |
| LRP bureau/Metro2 readiness blockers (LRP-402) | 29.0 / V1.0 | ✅      | ✅      | ✅       | —   | —   | ✅      | Accounts         | Compose `lrs.v1.1` surfaces cross-bureau + high-severity Metro 2 blockers + compliance_summary; advisory only                                                              |
| LRP consultation completed pack (LRP-204)      | 29.0 / V1.0 | ✅      | ✅      | ✅       | ✅  | —   | ✅      | Cases            | Staff-gated draft pack + ZIP/text export; partner notify never auto-sent; CRM generate/download                                                                            |
...
| LRP CRM borrower workspace (Vol 21 E5.3–E5.4)  | 29.0        | Partial | ✅      | Partial  | ✅  | —   | ✅      | Clients/cases    | Overview + POST credit-analysis run/publish; case documents live (LRP-107); tasks/notes/export deferred                                                                    |
| LRP CRM case documents (LRP-107)               | 29.0 / V1.0 | ✅      | ✅      | ✅       | —   | —   | ✅      | Documents        | `/crm/borrowers/[id]` Documents panel: list/upload/download via Documents API; `documents.manage` upload gate                                                              |
