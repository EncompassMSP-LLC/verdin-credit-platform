...
| LRP portal task/readiness parity (LRP-104)     | 29.0 / V1.0 | ✅      | ✅      | ✅       | ✅  | —   | ✅      | Client portal    | Checklist API from readiness blockers + baseline; `/portal/tasks` ↔ `/portal/readiness` deep links; completion persistence                                                 |
