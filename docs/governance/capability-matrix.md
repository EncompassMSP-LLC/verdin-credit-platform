...
| LRP LO notifications center (LRP-105)          | 29.0 / V1.0 | ✅      | ✅      | ✅       | —   | —   | ✅      | Notifications    | `/lender/notifications` + shell/dashboard unread via platform notifications API; demo seed fallback; producers → LRP-202                                                   |
