...
| LRP V1.0 release + tag (LRP-505)               | 29.0 / V1.0 | —       | —       | —        | ✅  | —   | ✅      | Release          | `docs/release-notes/lrp-platform-v1.0.0.md` + tag `lrp-platform-v1.0.0`; checklist closeout; ops sign-off/DR remain post-tag                                               |
