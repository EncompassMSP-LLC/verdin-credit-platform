...
| Capability                      | Version | Status  | Backend | Frontend | API | AI      | Tests | Dependencies        | Notes                                             |
| ------------------------------- | ------- | ------- | ------- | -------- | --- | ------- | ----- | ------------------- | ------------------------------------------------- |
| Workflow Automation             | 4.5     | Partial | 🚧      | 🚧       | 🚧  | —       | ✅    | Timeline, Tasks     | Parsed report review tasks auto-created by worker |
...
| Dispute Generation (foundation) | 4.5     | Partial | 🚧      | 🚧       | 🚧  | ✅      | ✅    | Accounts, Documents | Persisted drafts + per-letter review task handoff |
