...
- [x] All four epics below are **✅ or explicitly deferred** with docs updated — see [`version-5.8-scope.md`](../governance/version-5.8-scope.md)
- [x] Capability matrix updated for 5.8 slices
- [x] Supervised loops, bureau API, tax calculation, and HRIS lifecycle paths verified behind feature flags
- [x] `docs/release-notes/v5.8.0.md` + tag `v5.8.0`
