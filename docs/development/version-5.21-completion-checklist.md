...
Preceded by shipped **v5.20.0**. **Targeting v5.21.0.**
...
- [ ] Reinvestigation outcome analytics support a single-call per-recipient breakdown
...
- [ ] `docs/release-notes/v5.21.0.md` + tag `v5.21.0`
