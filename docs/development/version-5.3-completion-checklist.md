...
Ordered path to **enterprise depth** — **complete**. Preceded by shipped **v5.2.0** deferred production surfaces.

Linked from [`docs/roadmap/README.md`](../roadmap/README.md).

## Exit criteria for “5.3 done”

- [x] All five epics below are **✅ or explicitly deferred** with docs updated — see [`version-5.3-scope.md`](../governance/version-5.3-scope.md)
- [x] Capability matrix updated for 5.3 slices
- [x] SCIM and usage metering paths verified behind feature flags
- [x] `docs/release-notes/v5.3.0.md` + tag `v5.3.0`
