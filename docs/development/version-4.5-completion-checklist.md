...
- [x] `v4.5.0` release notes — [`docs/release-notes/v4.5.0.md`](../release-notes/v4.5.0.md); tag pending slice 5.6
...
| 5     | `docs/release-notes/v4.5.0.md`                  | 5.5  | ✅ Phase 2 #5 |
| 6     | Tag `v4.5.0`                                    | 5.6  | **Next**      |
