...
Ordered path to **production hardening** — **Phase 1 complete** (v5.1.0 RC sign-off). Preceded by **5.0+ pilot-ready** sign-off.
...
| Production SMS delivery | 5.2+    | Deferred from 5.1 RC   |
| LLM document summary UI | 5.2+    | Deferred from 5.1 RC   |
