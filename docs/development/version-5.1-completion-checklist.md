...
Ordered path to **production hardening** — **complete**. Preceded by **5.0+ pilot-ready** sign-off.

Linked from [`docs/roadmap/README.md`](../roadmap/README.md).

## Exit criteria for “5.1 done”

- [x] All eight epics below are **✅ or explicitly deferred** with docs updated — see [`version-5.1-scope.md`](../governance/version-5.1-scope.md)
- [x] Capability matrix updated for 5.1 slices
- [x] API keys authenticate on at least one production integration path
- [x] `docs/release-notes/v5.1.0.md` + tag `v5.1.0`
...
| Production SMS delivery | 5.2+    | Deferred from 5.1.0    |
| LLM document summary UI | 5.2+    | Deferred from 5.1.0    |
