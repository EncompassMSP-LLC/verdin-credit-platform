...
Ordered path to **production operations** — **complete**. Preceded by shipped **v5.3.0** enterprise depth.

Linked from [`docs/roadmap/README.md`](../roadmap/README.md).

## Exit criteria for “5.4 done”

- [x] All four epics below are **✅ or explicitly deferred** with docs updated — see [`version-5.4-scope.md`](../governance/version-5.4-scope.md)
- [x] Capability matrix updated for 5.4 slices
- [x] Invoicing and federation paths verified behind feature flags
- [x] `docs/release-notes/v5.4.0.md` + tag `v5.4.0`
