...
Ordered path to **deferred production surfaces** — **complete**. Preceded by shipped **v5.1.0** production hardening.

Linked from [`docs/roadmap/README.md`](../roadmap/README.md).

## Exit criteria for “5.2 done”

- [x] All five epics below are **✅ or explicitly deferred** with docs updated — see [`version-5.2-scope.md`](../governance/version-5.2-scope.md)
- [x] Capability matrix updated for 5.2 slices
- [x] Production SMS and LLM document summary paths verified behind feature flags
- [x] `docs/release-notes/v5.2.0.md` + tag `v5.2.0`
