...
class FeatureFlag(StrEnum):
    ...
    ENABLE_NATIVE_MOBILE_PASSKEY_CLIENT = "ENABLE_NATIVE_MOBILE_PASSKEY_CLIENT"
    ENABLE_NATIVE_MOBILE_APP_STORE_DISTRIBUTION = "ENABLE_NATIVE_MOBILE_APP_STORE_DISTRIBUTION"
    ...
    ENABLE_UNSUPERVISED_AUTONOMOUS_FILING_LOOPS = "ENABLE_UNSUPERVISED_AUTONOMOUS_FILING_LOOPS"
...
class FeatureFlags(BaseSettings):
    ...
    enable_native_mobile_passkey_client: bool = Field(
        default=False,
        description="Enable admin-gated native mobile passkey client audit scaffold",
    )
    enable_native_mobile_app_store_distribution: bool = Field(
        default=False,
        description="Enable admin-gated native mobile app store distribution readiness scaffold",
    )
    ...
    enable_unsupervised_autonomous_filing_loops: bool = Field(
        default=False,
        description="Enable operator-gated unsupervised autonomous filing loop audit scaffold",
    )
...
_FLAG_FIELD_MAP: dict[FeatureFlag, str] = {
    ...
    FeatureFlag.ENABLE_NATIVE_MOBILE_PASSKEY_CLIENT: "enable_native_mobile_passkey_client",
    FeatureFlag.ENABLE_NATIVE_MOBILE_APP_STORE_DISTRIBUTION: (
        "enable_native_mobile_app_store_distribution"
    ),
    ...
    FeatureFlag.ENABLE_UNSUPERVISED_AUTONOMOUS_FILING_LOOPS: (
