...
import { CaseLlmSummaryPanel } from '../../components/cases/CaseLlmSummaryPanel';
...
import { CaseReinvestigationSummaryCard } from '../../components/imports/ReinvestigationSummaryCard';
  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <CaseLitigationStrengthPanel
          caseId={caseId}
          className="lg:col-span-3"
          id="litigation-strength"
        />

        <CaseIssueExplainabilityPanel
          caseId={caseId}
          className="lg:col-span-3"
        ...
        <CaseLetterDraftBuilderPanel
          caseId={caseId}
          className="lg:col-span-3"
          id="letter-draft-builder"
        />

        <CaseDisputeStrategyPanel caseId={caseId} className="lg:col-span-3" id="dispute-strategy" />

        <CaseReinvestigationSummaryCard
          caseId={caseId}
          className="lg:col-span-3"
          id="reinvestigation-summary"
        />

        <CaseReinvestigationClockPanel
          caseId={caseId}
          className="lg:col-span-3"
        ...
        <CaseLlmSummaryPanel caseId={caseId} />
      </div>
